...
if (isset($_SESSION['auth_data'])) { ?>
    <div id="register_form" style="overflow-y: scroll;overflow-x: hidden;"><br>
        <span onclick="return backToUserPanel();" id="back-to-panel" class="mobhide"><i class="fas fa-arrow-left"></i> Back to panel</span>
        <br><br>
        <?php
        session_start();
        ...
        foreach ($i as $photo) {
            ...
            <div class="img-manager">
                ...
                <div class="img-del-over" id="toDel<?php echo $photo[0]; ?>" onclick="return delPhoto(this);"><i
                            class="fas fa-trash trash"></i>
                    <p class="delete">Remove</p></div>
            </div>
            <?php
        }
        ?>
