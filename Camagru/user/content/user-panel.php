...
if (isset($_SESSION['auth_data'])) { ?>
    <div id="user-panel-logged">
        <img id="user-avatar-desktop" src=<?php
        ...
        <p class="counter posts"><?php
            ...
            echo $q;
            ?></p>
        <div class="panel-menu-dektop">
            <a href="/""><p class="menu">Gallery</p></a>
            <hr class="panel">
            <a href="?page=new"><p class="menu">+ Create a New Post</p></a>
            <hr class="panel">
            <a onclick="return managePosts();"><p class="menu">Manage Your Posts</p></a>
            <hr class="panel">
